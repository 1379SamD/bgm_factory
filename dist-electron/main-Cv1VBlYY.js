...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-_IsPL3av.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-S4fQtgZe.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CvJXyz64.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BgmCxtYS.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-8QcpDJUu.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-GnzM2RUY.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-Bo-3L2GT.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-BGs_yR8q.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-D1mtP0Hh.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BSR6flch.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-CQr2KYXl.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-dcyesScq.js")).WaveParser;
  }
};
...
ipcMain.handle(
  "save-video-meta",
  async (_event, saveDir, publishDate2, publishTime2) => {
    const folderName = formatFolderName(publishDate2, publishTime2);
...
ipcMain.handle(
  ...
  async (_event, targetDir, meta) => {
    formatFolderName(publishDate, publishTime);
    const jsonFilePath = path.join(
      targetDir,
      `_${meta.title.split(" ")[0]}.json`
      // `test.json`,
    );
