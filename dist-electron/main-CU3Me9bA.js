...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DI9ZE2V4.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-kwdNmIOG.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BOgZpuSn.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-znK6J4MT.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DyhvWFAt.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-D8AY-l-6.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BjB22k_f.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CTXTzv14.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-D-4NQq6Q.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-sUcyROO2.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B8Efq4iC.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BLk5p07r.js")).WaveParser;
  }
};
