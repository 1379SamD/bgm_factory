...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-By_hWkBl.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BcSVbPVL.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-DqBVSXGE.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-CAq5oJdS.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DYIqCRjw.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-opG7SZIo.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BpFOCjeJ.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-B-koETIf.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CPxm8IJc.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-Fr0Tug7J.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B-BBlcNf.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-yGCcVYuc.js")).WaveParser;
  }
};
...
ipcMain.handle(
  ...
  async (_event, outputDir, backgroundPath) => {
    ...
    const cmd = `ffmpeg -y -loop 1 -framerate 2 -i "${imagePath}" -i "${audioPath}" -fflags +genpts -vf "scale=1920:1080:force_original_aspect_ratio=increase,crop=1920:1080" -c:v h264_nvenc -preset p4 -bf 0 -c:a aac -b:a 192k -pix_fmt yuv420p -movflags +faststart -shortest "${outputPath}"`;
...
ipcMain.handle("load-json-files", async (_event, dirPath) => {
  try {
