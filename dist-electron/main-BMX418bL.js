...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DJM6ha_d.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CUm1-cN5.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CvIQLj6h.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-DJRKbOtX.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BBXa3lGi.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BcuGxDZ1.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BFYDlI5k.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-GrGdlMXN.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BbF0pwj1.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DWsr1KCK.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-LIdWOPB7.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-DT5jEVYB.js")).WaveParser;
  }
};
