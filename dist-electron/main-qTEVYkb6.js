...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DlHW019r.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BZ9CWjeJ.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BR6WxyNs.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BOvmw_zC.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BqkAbxuU.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-_Zhj5sZE.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BBJgBKm9.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CHCM8Kg7.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CZ7FQBrC.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-l-dxjilv.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B9gZp8z1.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BKDw0ODx.js")).WaveParser;
  }
};
...
ipcMain.handle(
  ...
  async (_event, outputDir, backgroundPath) => {
    ...
    const cmd = `ffmpeg -y -loop 1 -i "${imagePath}" -i "${audioPath}" -r 5 -c:v h264_nvenc -preset p4 -g 5 -c:a aac -b:a 192k -pix_fmt yuv420p -movflags +faststart -shortest "${outputPath}"`;
