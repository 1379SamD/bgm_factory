...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CIQ2Bxp6.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-DTdgz8uf.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-Do2UUp9O.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-fOzXHKI9.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B6G5pvBS.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-CguCAphP.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CLfk3uuL.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Bcs_Foin.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CmPZX0S2.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CoU7xoJ7.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B_ksVCl0.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-C-4REyEl.js")).WaveParser;
  }
};
...
ipcMain.handle("load-fixed-mp3", async () => {
  ...
  try {
    ...
    const mp3Names = entries.filter((name) => name.toLowerCase().endsWith(".mp3")).sort((a, b) => a.localeCompare(b, void 0, { numeric: true }));
...
ipcMain.handle("wavFile-generate", async (_event, outputDir) => {
  ...
  const outputPath = path.join(outputDir, "output.mp3").replace(/\\/g, "/");
  return await new Promise((resolve, reject) => {
    exec(
      `ffmpeg -f concat -safe 0 -i ${txtPath} -c copy ${outputPath}`,
      (err) => {
        if (err) {
          console.error("エラー:", rejecterr);
          return;
        }
        resolve(true);
        console.log("結合完了！");
...
ipcMain.handle("mp4File-generate", async (_event, outputDir, thumbnailPath) => {
  const audioPath = path.join(outputDir, "output.mp3").replace(/\\/g, "/");
  const outputPath = path.join(outputDir, "output.mp4").replace(/\\/g, "/");
  exec(
    `ffmpeg -loop 1 -i "${thumbnailPath}" -i "${audioPath}"   -c:v libx264 -tune stillimage -c:a aac -b:a 192k   -pix_fmt yuv420p -shortest "${outputPath}"`,
    (err) => {
      if (err) {
