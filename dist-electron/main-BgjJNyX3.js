...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-sBLgToVq.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-DUzF1VMS.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CRTUpjbf.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-cD7mZz70.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BPG2jpT0.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-Db_I_mRj.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-wo0vv7Ff.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CKEn-RfV.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-D8mkYzj2.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DCCdI1FB.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DJHk86af.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-bpheTe-7.js")).WaveParser;
  }
};
...
ipcMain.handle(
  ...
  async (_event, saveDir, publishDate, publishTime) => {
    const folderName2 = formatFolderName(publishDate, publishTime);
    const targetDir = path.join(saveDir, folderName2);
...
ipcMain.handle(
  ...
  async (_event, targetDir, meta) => {
    const jsonFilePath = path.join(
      targetDir,
      `${folderName}_${meta.title.split(" ")[0]}.json`
      // `test.json`,
    );
