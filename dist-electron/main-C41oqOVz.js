...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CYecC_SK.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-DUzEn3Ka.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-xoTx1h8l.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-tIttwSM9.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BXCH3DdY.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BvSXnz8r.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-Ct6aF4-e.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-maHXO3N3.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BjeLOLHo.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DPfiZbjx.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-C_jermA2.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CdsJuS1q.js")).WaveParser;
  }
};
...
function pickPreload() {
  ...
  for (const p of candidates) {
    const ok = fsSync.existsSync(p);
    console.log("[preload candidate]", p, ok);
    if (ok) return p;
  }
  console.error("[preload] NOT FOUND in candidates");
  return candidates[0];
}
function createWindow() {
  const preloadPath = pickPreload();
