...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CEq7NcD4.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-DB6LmSKo.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BF__jv37.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-IAjdbNXb.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-lka5h9Ne.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-aW7T7mHU.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-Dahw1szT.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-WQ1_YSk5.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-DfbQT10Z.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BtHzhDF8.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-D5c0sO_A.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-3-QcYCU0.js")).WaveParser;
  }
};
...
function createWindow() {
  const p1 = path.join(app.getAppPath(), "dist-electron", "preload.js");
  const p2 = path.join(__dirname, "preload.js");
  const preloadPath = fsSync.existsSync(p1) ? p1 : p2;
  console.log("[preload path 1]", p1, fsSync.existsSync(p1));
  console.log("[preload path 2]", p2, fsSync.existsSync(p2));
...
ipcMain.handle("load-fixed-mp3", async () => {
  ...
  try {
    ...
    return { ok: false, error: (e == null ? void 0 : e.message) ?? "Unknown error", folder, files: [] };
  }
});
export {
