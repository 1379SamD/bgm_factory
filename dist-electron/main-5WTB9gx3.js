...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BRIUXbyO.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-wyrsMJ2v.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-mMvGmDVJ.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-DiQZiAIY.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-D-x9DAVO.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-DyWPWROC.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CULLmgTi.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CEb8sFo5.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CztLGcI3.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CP7JyCXH.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-BINEgi-p.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-DOyGU8ny.js")).WaveParser;
  }
};
...
ipcMain.handle(
  ...
  async (_event, outputDir, backgroundPath) => {
    const imagePath = thumbnailPath.replace(/\\/g, "/");
    const audioPath = path.join(outputDir, "output.mp3").replace(/\\/g, "/");
    const outputPath = path.join(outputDir, "output.mp4").replace(/\\/g, "/");
    const cmd = `ffmpeg -y -loop 1 -framerate 1 -i "${imagePath}" -i "${audioPath}" -c:v h264_nvenc -preset p4 -c:a aac -b:a 192k -pix_fmt yuv420p -shortest "${outputPath}"`;
    return await new Promise((resolve, reject) => {
      exec(cmd, (err, stderr) => {
        if (err) {
