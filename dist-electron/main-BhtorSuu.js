...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-B1NCWjn4.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CujNvj57.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-C14V9n7e.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-B9PZz5Fq.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-PFhiH0aU.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-CoUuzItn.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-DgfMD0Nz.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-ZAbx7OiR.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-Cly3lii1.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CuhkI5-n.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-BWod3DV5.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CdjOIp95.js")).WaveParser;
  }
};
...
function formatFolderName(date, time) {
  const ymd = date.replace(/-/g, "");
  const hm = time.replace(/:/g, "");
  return `${ymd}_${hm}`;
}
function formatJsonName(publishAt) {
...
ipcMain.handle("load-fixed-mp3", async () => {
  ...
  try {
    ...
    const mp3Names = entries.filter((name) => name.toLowerCase().endsWith(".wav")).sort((a, b) => a.localeCompare(b, void 0, { numeric: true }));
...
ipcMain.handle(
  "wavFile-concat",
  async (_event, bgmDetail, outputDir) => {
...
ipcMain.handle("wavFile-generate", async (_event, outputDir) => {
...
ipcMain.handle(
  "mp4File-generate",
  async (_event, outputDir, backgroundPath) => {
    ...
    const cmd = `ffmpeg -y -loop 1 -framerate 1 -i "${imagePath}" -i "${audioPath}" -vf "scale=1920:1080:force_original_aspect_ratio=decrease,pad=1920:1080:(ow-iw)/2:(oh-ih)/2,format=yuv420p" -r 1 -c:v h264_nvenc -preset p4 -c:a aac -b:a 192k -map 0:v:0 -map 1:a:0 -shortest -fflags +genpts -avoid_negative_ts make_zero -movflags +faststart "${outputPath}"`;
